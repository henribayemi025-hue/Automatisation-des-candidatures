/**
 * Assemblage de « L'autre moitié, sur ordinateur » : carte d'intro, puis pour chaque
...
const SORTIE = '/tmp/video/finjaro-sur-ordinateur.mp4';
...
const TEL = { x: 240, y: 232, w: 1440, h: 810, r: 26 };
...
const liste = [];
ff(['-loop', '1', '-i', `${SC}/carte-intro.png`, '-t', '3.8', '-vf', 'fade=t=in:st=0:d=0.5:color=0xFAF6F0,fade=t=out:st=3.0:d=0.4:color=0xFAF6F0', ...ENC, `${SC}/b-intro.mp4`]);
